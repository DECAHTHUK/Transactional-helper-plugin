...
public class LazyInitializationPresentDifferentRelationsWithNoOngoing {
    ...
    public void innerMethod() {
        ...
        <warning descr="Getter call on a lazy initialized class without session. Make sure you are calling @Id getter or the class is initialized.">testEntity.getTestEntity2RelList()</warning>;
        TestEntity2 testEntity2 = new TestEntity2();
        <warning descr="Getter call on a lazy initialized class without session. Make sure you are calling @Id getter or the class is initialized.">testEntity2.getTestEntity3RelList()</warning>;
        ...
        <warning descr="Getter call on a lazy initialized class without session. Make sure you are calling @Id getter or the class is initialized.">testEntity3.getTestEntity2RelList()</warning>;
    }
}
...
class TestEntity {
    ...
    @OneToMany(mappedBy="testEntityRel", fetch = FetchType.LAZY)
